 ...
 * @author user
 */
public class Employee_Manager_Login_UI extends javax.swing.JFrame {

    /**
     * Creates new form Employee_Manager_Login_UI
     */
    public Employee_Manager_Login_UI() {
        initComponents();
        setSize(855,447);
        setResizable(false);
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Employee Manager Login");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(230, 20, 320, 29);
        ...
        jLabel2.setBounds(420, 100, 64, 64);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Frontend/resources/Employee_Manager_Login_image.jpg"))); // NOI18N
        jLabel1.setText("jLabel1");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(-35, 0, 1410, 420);
    ...
    private void buttonHomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonHomeActionPerformed
        dispose();
        StaffPortal emp1 = new StaffPortal();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Employee_Manager_Login_UI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Employee_Manager_Login_UI().setVisible(true);
            }
        });
    }
